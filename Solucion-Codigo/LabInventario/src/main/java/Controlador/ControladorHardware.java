...
public class ControladorHardware {
    ...
    public String registrarMantenimiento(Persona usuario, Hardware hw,
        ...
        activoDAO.actualizar(hw, lab.getCodigoLab(), lab.getCEDdocenteEncargado());
    ...
    /**
     * Obtiene lista filtrada según permisos del usuario. - Admin: Ve TODO -
     * Docente: Solo sus laboratorios asignados - Usuario: Solo lectura de todos
     */
