...
public class ServicioLaboratorio {
    ...
    public boolean agregarActivo(Laboratorio lab, Activo activo) {
        ...
        if (existe) {
            throw new IllegalArgumentException("El activo " + activo.getCodigo() + " ya existe en este laboratorio.");
        }
        ...
        if (activo instanceof Hardware && hwCount >= lab.getCapacidadMaximaHardware()) {
            throw new IllegalStateException("Laboratorio lleno. Máx: " + lab.getCapacidadMaximaHardware() + " equipos.");
        }
